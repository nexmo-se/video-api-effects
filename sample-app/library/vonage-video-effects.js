 ...
 * =============================================================================
 */
const g=(0,m.b)(((e,t)=>e<0?t*e:e));function x(e){const{inputs:t,backend:n}=e,{x:r,alpha:s}=t;(0,a.H)([r,s],"prelu");const o=n.data.get(r.dataId).values,i=n.data.get(s.dataId).values,[u,l]=g(r.shape,s.shape,o,i,r.dtype);return n.makeTensorInfo(l,r.dtype,u)}const b={kernelName:r.o0g,backendName:"cpu",kernelFunc:x},v=(0,l.A)(r.qkr,(e=>Math.max(0,e))),y={kernelName:r.qkr,backendName:"cpu",kernelFunc:v},k=(0,l.A)(r.SbG,(e=>Math.min(Math.max(0,e),6))),I={kernelName:r.SbG,backendName:"cpu",kernelFunc:k};var w=n(108);
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function E(e){const{inputs:t,backend:n,attrs:s}=e,{a:o,b:i}=t,{transposeA:u,transposeB:l}=s;(0,a.H)([o,i],"matMul");const c=o.shape.length,d=i.shape.length,p=u?o.shape[c-2]:o.shape[c-1],h=l?i.shape[d-1]:i.shape[d-2],f=u?o.shape[c-1]:o.shape[c-2],m=l?i.shape[d-2]:i.shape[d-1],g=o.shape.slice(0,-2),x=i.shape.slice(0,-2),b=r.D5U.sizeFromShape(g),v=r.D5U.sizeFromShape(x),y=b===v||1===b||1===v;r.D5U.assert(c>=2&&d>=2&&y,(()=>`Error in matMul: the input batch dimensions must either be the same or at least one input batch dimension must be 1. Got input batch dimensions of (${g}) and (${x}).`));const k=(b>v?o.shape.slice(0,-2):i.shape.slice(0,-2)).concat([f,m]);r.D5U.assert(p===h,(()=>`Error in matMul: inner shapes (${p}) and (${h}) of Tensors with shapes ${o.shape} and ${i.shape} and transposeA=${u} and transposeB=${l} must match.`));const I=l?[v,m,h]:[v,h,m],w=$({inputs:{x:o},backend:n,attrs:{shape:u?[b,p,f]:[b,f,p]}}),C=$({inputs:{x:i},backend:n,attrs:{shape:I}}),S=u?w.shape[1]:w.shape[2],T=u?w.shape[2]:w.shape[1],E=l?C.shape[1]:C.shape[2],N=Math.max(b,v),R=n.data.get(w.dataId).values,D=n.data.get(C.dataId).values,A=r.D5U.computeStrides(w.shape),F=r.D5U.computeStrides(C.shape),[_,O,M]=u?[A[0],1,A[1]]:[A[0],A[1],1],[U,W,P]=l?[1,F[1],F[0]]:[F[1],1,F[0]],B=T*E,L=(0,r.f3b)([N,T,E],w.dtype),z=L.values,V=n.blockSize;for(let e=0;e<N;e++)for(let t=0;t<T;t+=V)for(let n=0;n<E;n+=V)for(let r=0;r<S;r+=V){const a=Math.min(t+V,T),s=Math.min(n+V,E),o=Math.min(r+V,S);for(let i=t;i<a;i++)for(let t=n;t<s;t++){let n=0;for(let a=r;a<o;a++){const r=Math.min(e,b-1)*_,s=Math.min(e,v-1)*P;n+=R[r+i*O+a*M]*D[a*U+t*W+s]}z[e*B+(i*E+t)]+=n}}return n.disposeIntermediateTensorInfo(w),n.disposeIntermediateTensorInfo(C),n.makeTensorInfo(k,L.dtype,L.values)}const N={kernelName:r.XLW,backendName:"cpu",kernelFunc:E};const R={kernelName:r.usg,backendName:"cpu",kernelFunc:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 ...
 * =============================================================================
 */
function(e){const{inputs:t,backend:n}=e,s=t;(0,a.H)(t,"addN");const o=s.map((e=>n.data.get(e.dataId).values)),i=(0,r.f3b)(s[0].shape,s[0].dtype),u=i.values;for(let e=0;e<s.length;e++){const t=o[e];for(let e=0;e<u.length;e++)u[e]+=t[e]}return n.makeTensorInfo(i.shape,i.dtype,i.values)}};var U=n(4802);const W={kernelName:r.oT6,backendName:"cpu",kernelFunc:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const{inputs:t,backend:n,attrs:s}=e,{x:o}=t,{axis:i,keepDims:u}=s;(0,a.H)(o,"all");const l=r.D5U.parseAxisParam(i,o.shape);let c=l;const d=r.Wap.getAxesPermutation(c,o.shape.length);let p=o;null!=d&&(p=(0,U.p)({inputs:{x:o},backend:n,attrs:{perm:d}}),c=r.Wap.getInnerMostAxes(c.length,o.shape.length)),r.Wap.assertAxesAreInnerMostDims("all",c,p.shape.length);const[h,f]=r.Wap.computeOutAndReduceShapes(p.shape,c),m=r.D5U.sizeFromShape(f),g=r.D5U.makeZerosTypedArray(r.D5U.sizeFromShape(h),p.dtype),x=n.data.get(p.dataId).values;for(let e=0;e<g.length;++e){const t=e*m;let n=x[t];for(let e=0;e<m;++e){const r=x[t+e];n=n&&r}g[e]=n}null!=d&&n.disposeIntermediateTensorInfo(p);const b=n.makeTensorInfo(h,p.dtype,g);if(u){const e=$({inputs:{x:b},backend:n,attrs:{shape:r.Wap.expandShapeToKeepDim(h,l)}});return n.disposeIntermediateTensorInfo(b),e}return b}};const P={kernelName:r.IKK,backendName:"cpu",kernelFunc:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function Se(e){const{inputs:t,backend:n,attrs:s}=e,{x:o,filter:i}=t,{strides:u,pad:l,dataFormat:c,dilations:d,dimRoundingMode:p}=s;(0,a.H)([o,i],"conv2d");const h=r.Wap.convertConv2DDataFormat(c),f=r.Wap.computeConv2DInfo(o.shape,i.shape,u,d,l,p,!1,h),m=f.filterHeight,g=f.filterWidth,x=f.dilationHeight,b=f.dilationWidth,v=f.padInfo.left,y=f.padInfo.top,k="channelsLast"===f.dataFormat,I=new r.YDk(f.outShape,o.dtype),w=r.D5U.computeStrides(o.shape),C=r.D5U.computeStrides(i.shape),S=w[0],$=k?w[1]:w[2],T=k?w[2]:1,E=k?1:w[1],N=I.strides[0],R=k?I.strides[1]:I.strides[2],D=k?I.strides[2]:1,A=k?1:I.strides[1],F=n.data.get(o.dataId).values,_=n.data.get(i.dataId).values,O=I.values;for(let e=0;e<f.batchSize;++e){const t=e*S,n=e*N;for(let e=0;e<f.outHeight;++e){const r=n+e*R,a=e*f.strideHeight-y;for(let e=0;e<m;++e){const n=a+e*x;if(n<0||n>=f.inHeight)continue;const s=e*C[0],o=t+n*$;for(let e=0;e<f.outWidth;++e){const t=r+e*D,n=e*f.strideWidth-v;for(let e=0;e<g;++e){const r=n+e*b;if(r<0||r>=f.inWidth)continue;const a=o+r*T;let i=s+e*C[1];for(let e=0;e<f.inChannels;++e){const n=F[a+e*E];for(let e=0;e<f.outChannels;++e)O[t+e*A]+=n*_[i+e];i+=f.outChannels}}}}}}return n.makeTensorInfo(I.shape,I.dtype,O)}const $e={kernelName:r.mhS,backendName:"cpu",kernelFunc:Se};const Te={kernelName:r.wUP,backendName:"cpu",kernelFunc:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const{inputs:t,backend:n,attrs:s}=e,{dy:o,filter:i}=t,{inputShape:u,strides:l,pad:c,dataFormat:d,dimRoundingMode:p}=s;(0,a.H)([o,i],"conv2dBackpropInput");const h=r.D5U.computeStrides(i.shape),f=r.D5U.computeStrides(o.shape);let m=r.Wap.convertConv2DDataFormat(d);const g=r.Wap.computeConv2DInfo(u,i.shape,l,1,c,p,!1,m),x=new r.YDk(g.inShape,"float32"),b=x.values,v=n.data.get(o.dataId).values,y=n.data.get(i.dataId).values,[k,I,w]=h,{batchSize:C,filterHeight:S,filterWidth:$,inChannels:T,inHeight:E,inWidth:N,outChannels:R,outHeight:D,outWidth:A,strideHeight:F,strideWidth:_}=g;m=g.dataFormat;const O=S-1-g.padInfo.top,M=$-1-g.padInfo.left,U="channelsLast"===m,W=x.strides[0],P=U?x.strides[1]:x.strides[2],B=U?x.strides[2]:1,L=U?1:x.strides[1],z=f[0],V=U?f[1]:f[2],G=U?f[2]:1,H=U?1:f[1];for(let e=0;e<C;++e)for(let t=0;t<T;++t)for(let n=0;n<E;++n){const r=n-O,a=Math.max(0,Math.ceil(r/F)),s=Math.min(D,(S+r)/F);for(let o=0;o<N;++o){const i=o-M,u=Math.max(0,Math.ceil(i/_)),l=Math.min(A,($+i)/_);let c=0;for(let n=a;n<s;++n){const a=n*F-r;for(let r=u;r<l;++r){const s=z*e+V*n+G*r,o=k*(S-1-a)+I*($-1-(r*_-i))+w*t;for(let e=0;e<R;++e){c+=v[s+H*e]*y[o+e]}}}b[W*e+P*n+B*o+L*t]=c}}return n.makeTensorInfo(x.shape,x.dtype,x.values)}};const Ne={kernelName:r.x12,backendName:"cpu",kernelFunc:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const{inputs:t,backend:n,attrs:s}=e,{dy:o,filter:i}=t,{pad:u,strides:l,inputShape:c}=s;(0,a.H)([o],"conv3dBackpropInputV2");const d=r.D5U.computeStrides(o.shape),p=r.D5U.computeStrides(i.shape),h=r.Wap.computeConv3DInfo(c,i.shape,l,1,u),f=new r.YDk(h.inShape,"float32"),m=f.values,[g,x,b,v]=f.strides,y=n.data.get(o.dataId).values,[k,I,w,C]=d,S=n.data.get(i.dataId).values,[$,T,E,N]=p,{batchSize:R,filterDepth:D,filterHeight:A,filterWidth:F,inChannels:_,inDepth:O,inHeight:M,inWidth:U,outChannels:W,outDepth:P,outHeight:B,outWidth:L,strideDepth:z,strideHeight:V,strideWidth:G}=h,H=D-1-h.padInfo.front,j=A-1-h.padInfo.top,X=F-1-h.padInfo.left;for(let e=0;e<R;++e)for(let t=0;t<_;++t)for(let n=0;n<O;++n){const r=n-H,a=Math.max(0,Math.ceil(r/z)),s=Math.min(P,(D+r)/z);for(let o=0;o<M;++o){const i=o-j,u=Math.max(0,Math.ceil(i/V)),l=Math.min(B,(A+i)/V);for(let c=0;c<U;++c){const d=c-X,p=Math.max(0,Math.ceil(d/G)),h=Math.min(L,(F+d)/G);let f=0;for(let n=a;n<s;++n){const a=n*z-r;for(let r=u;r<l;++r){const s=r*V-i;for(let o=p;o<h;++o){const i=k*e+I*n+w*r+C*o,u=$*(D-1-a)+T*(A-1-s)+E*(F-1-(o*G-d))+N*t;for(let e=0;e<W;++e){f+=y[i+e]*S[u+e]}}}}m[g*e+x*n+b*o+v*c+t]=f}}}return n.makeTensorInfo(f.shape,f.dtype,f.values)}},Ae=(0,l.A)(r.mc4,(e=>Math.cos(e))),Fe={kernelName:r.mc4,backendName:"cpu",kernelFunc:Ae},_e=(0,l.A)(r.TR1,(e=>Math.cosh(e))),Oe={kernelName:r.TR1,backendName:"cpu",kernelFunc:_e};const Me={kernelName:r.VcC,backendName:"cpu",kernelFunc:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const{inputs:t,backend:n,attrs:r}=e,{x:a,weights:s}=t,{size:o,binaryOutput:i}=r;if(1===a.shape.length){const e=n.data.get(a.dataId).values,t=n.data.get(s.dataId).values,r=(0,ce.W)(e,t,s.dtype,s.shape,o);return n.makeTensorInfo([o],s.dtype,r)}if(2===a.shape.length){const e=n.bufferSync(a),t=n.bufferSync(s),r=(0,ce.i)(e,t,o,i);return n.makeTensorInfo(r.shape,s.dtype,r.values)}throw new Error(`Error in denseBincount: input must be at most rank 2, but got rank${a.shape.length}.`)}};const Pe={kernelName:r.T0n,backendName:"cpu",kernelFunc:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function Be(e){const{inputs:t,backend:n,attrs:s}=e,{x:o,filter:i}=t,{strides:u,pad:l,dilations:c,dimRoundingMode:d}=s;(0,a.H)([o,i],"depthwiseConv2DNative");const p=r.D5U.computeStrides(o.shape),h=r.D5U.computeStrides(i.shape);let f=c;null==f&&(f=[1,1]),r.D5U.assert(r.Wap.eitherStridesOrDilationsAreOne(u,f),(()=>`Error in depthwiseConv2d: Either strides or dilations must be 1. Got strides ${u} and dilations '${f}'`));const m=r.Wap.computeConv2DInfo(o.shape,i.shape,u,f,l,d,!0),{filterHeight:g,filterWidth:x,dilationHeight:b,dilationWidth:v,padInfo:y}=m,k=y.left,I=y.top,w=m.outChannels/m.inChannels,C=new r.YDk(m.outShape,o.dtype),S=n.data.get(o.dataId).values,$=n.data.get(i.dataId).values,T=C.values;for(let e=0;e<m.batchSize;++e){const t=e*p[0],n=e*C.strides[0];for(let e=0;e<m.outHeight;++e){const r=n+e*C.strides[1],a=e*m.strideHeight-I;for(let e=0;e<g;++e){const n=a+e*b;if(n<0||n>=m.inHeight)continue;const s=e*h[0],o=t+n*p[1];for(let e=0;e<m.outWidth;++e){const t=r+e*C.strides[2],n=e*m.strideWidth-k;for(let e=0;e<x;++e){const r=n+e*v;if(r<0||r>=m.inWidth)continue;const a=s+e*h[1],i=o+r*m.inChannels;let u=t,l=a;for(let e=0;e<m.inChannels;++e){const t=S[i+e];for(let e=0;e<w;++e)T[u+e]+=t*$[l+e];u+=w,l+=w}}}}}}return n.makeTensorInfo(C.shape,C.dtype,C.values)}const Le={kernelName:r.cie,backendName:"cpu",kernelFunc:Be};const ze={kernelName:r.sL$,backendName:"cpu",kernelFunc:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const{inputs:t,backend:n,attrs:s}=e,{dy:o,filter:i}=t,{strides:u,dilations:l,pad:c,dimRoundingMode:d,inputShape:p}=s;(0,a.H)([o,i],"depthwiseConv2DNativeBackpropInput");const h=r.D5U.computeStrides(o.shape),f=r.D5U.computeStrides(i.shape),m=r.Wap.computeConv2DInfo(p,i.shape,u,l,c,d,!0),g=new r.YDk(m.inShape,"float32"),x=g.values,[b,v,y]=g.strides,k=n.data.get(o.dataId).values,[I,w,C]=h,S=n.data.get(i.dataId).values,[$,T,E]=f,{batchSize:N,filterHeight:R,filterWidth:D,inChannels:A,inHeight:F,inWidth:_,outChannels:O,outHeight:M,outWidth:U,strideHeight:W,strideWidth:P}=m,B=R-1-m.padInfo.top,L=D-1-m.padInfo.left,z=O/A;for(let e=0;e<N;++e)for(let t=0;t<A;++t)for(let n=0;n<F;++n){const r=n-B,a=Math.max(0,Math.ceil(r/W)),s=Math.min(M,(R+r)/W);for(let o=0;o<_;++o){const i=o-L,u=Math.max(0,Math.ceil(i/P)),l=Math.min(U,(D+i)/P);let c=0;for(let n=a;n<s;++n){const a=n*W-r;for(let r=u;r<l;++r){const s=I*e+w*n+C*r,o=$*(R-1-a)+T*(D-1-(r*P-i))+E*t;for(let e=0;e<z;++e){c+=k[s+(t*z+e)]*S[o+e]}}}x[b*e+v*n+y*o+t]=c}}return n.makeTensorInfo(g.shape,g.dtype,g.values)}};const Ge={kernelName:r.$w,backendName:"cpu",kernelFunc:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const{inputs:t,backend:n,attrs:s}=e,{dy:o,input:i}=t,{filterSize:u,strides:l,pad:c,dimRoundingMode:d}=s;(0,a.H)([o,i],"maxPool3DGrad");const p=r.Wap.computePool3DInfo(i.shape,u,l,1,c,d),h=function(e,t){const n=(0,r.f3b)(t.outShape,"int32"),a=t.strideDepth,s=t.strideHeight,o=t.strideWidth,i=t.dilationDepth,u=t.dilationHeight,l=t.dilationWidth,c=t.effectiveFilterDepth,d=t.effectiveFilterHeight,p=t.effectiveFilterWidth,h=t.padInfo.front,f=t.padInfo.top,m=t.padInfo.left;for(let r=0;r<t.batchSize;++r)for(let g=0;g<t.inChannels;++g)for(let x=0;x<t.outDepth;++x){const b=x*a-h;let v=b;for(;v<0;)v+=i;const y=Math.min(t.inDepth,c+b);for(let a=0;a<t.outHeight;++a){const c=a*s-f;let h=c;for(;h<0;)h+=u;const k=Math.min(t.inHeight,d+c);for(let s=0;s<t.outWidth;++s){const f=s*o-m;let I=f;for(;I<0;)I+=l;const w=Math.min(t.inWidth,p+f);let C=Number.NEGATIVE_INFINITY,S=-1;for(let t=v;t<y;t+=i){const n=t-b;for(let a=h;a<k;a+=u){const s=a-c;for(let o=I;o<w;o+=l){const i=o-f,u=e.get(r,t,a,o,g);u>=C&&(C=u,S=n*d*p+s*d+i)}}}n.set(S,r,x,a,s,g)}}}return n}(n.bufferSync(i),p),f=p.strideDepth,m=p.strideHeight,g=p.strideWidth,x=p.dilationDepth,b=p.dilationHeight,v=p.dilationWidth,y=p.effectiveFilterDepth,k=p.effectiveFilterHeight,I=p.effectiveFilterWidth,w=y-1-p.padInfo.front,C=I-1-p.padInfo.left,S=k-1-p.padInfo.top,$=(0,r.f3b)(i.shape,"float32"),T=n.bufferSync(o);for(let e=0;e<p.batchSize;++e)for(let t=0;t<p.inChannels;++t)for(let n=0;n<p.inDepth;++n)for(let r=0;r<p.inHeight;++r)for(let a=0;a<p.inWidth;++a){const s=n-w,o=r-S,i=a-C;let u=0;for(let n=0;n<y;n+=x){const r=(s+n)/f;if(!(r<0||r>=p.outDepth||Math.floor(r)!==r))for(let a=0;a<k;a+=b){const s=(o+a)/m;if(!(s<0||s>=p.outHeight||Math.floor(s)!==s))for(let o=0;o<I;o+=v){const l=(i+o)/g;if(l<0||l>=p.outWidth||Math.floor(l)!==l)continue;const c=y*k*I-1-h.get(e,r,s,l,t)===n*k*I+a*I+o?1:0;if(0===c)continue;u+=T.get(e,r,s,l,t)*c}}}$.set(u,e,n,r,a,t)}return n.makeTensorInfo($.shape,$.dtype,$.values)}};const mn={kernelName:r.OV7,backendName:"cpu",kernelFunc:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const{inputs:t,backend:n,attrs:s}=e,{images:o,dy:i}=t,{alignCorners:u}=s;(0,a.H)([i,o],"resizeNearestNeighborGrad");const l=r.D5U.computeStrides(o.shape),c=r.D5U.computeStrides(i.shape),[d,p,h,f]=o.shape,[,m,g]=i.shape,x=new Float32Array(d*p*h*f),b=n.data.get(i.dataId).values,v=[u&&m>1?p-1:p,u&&g>1?h-1:h],y=[u&&m>1?m-1:m,u&&g>1?g-1:g],k=v[0]/y[0],I=v[1]/y[1],w=1/k,C=1/I,S=2*Math.ceil(w)+2,$=2*Math.ceil(C)+2;for(let e=0;e<d;e++){const t=e*l[0];for(let e=0;e<p;e++){const n=t+e*l[1],r=Math.floor(e*w),a=Math.floor(r-S/2);for(let r=0;r<h;r++){const s=n+r*l[2],o=Math.floor(r*C),i=Math.floor(o-$/2);for(let n=0;n<f;n++){let o=0;for(let s=0;s<S;s++){const l=s+a;if(l<0||l>=m)continue;const d=t+l*c[1],f=l*k;if(e===Math.min(p-1,u?Math.round(f):Math.floor(f)))for(let e=0;e<$;e++){const t=e+i;if(t<0||t>=g)continue;const a=d+t*c[2],s=t*I;r===Math.min(h-1,u?Math.round(s):Math.floor(s))&&(o+=b[a+n])}}x[s+n]=o}}}}return n.makeTensorInfo(o.shape,o.dtype,x)}};const tr={kernelName:r.mKl,backendName:"cpu",kernelFunc:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
const Or=(0,l.A)(r.h8e,((e,t)=>{const n=t;return isNaN(e)?NaN:e>0?1:n.alpha})),Mr={kernelName:r.h8e,backendName:"cpu",kernelFunc:Or};var Ur=n(2210);const Wr={kernelName:r.jQk,backendName:"cpu",kernelFunc:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const{inputs:t,backend:n,attrs:s}=e,{x:o}=t,{begin:i,end:u,strides:l,beginMask:c,endMask:d,ellipsisMask:p,newAxisMask:h,shrinkAxisMask:f}=s;(0,a.H)(o,"stridedSlice");const{nonStrided:m,$begin:g,$strides:x,size:b,newShape:v,outShape:y}=r.kuN.sliceInfo(o.shape,i,u,l,c,d,p,h,f),k=$({inputs:{x:o},backend:n,attrs:{shape:v}});let I;if(m){const e=(0,ue.tP)({inputs:{x:k},backend:n,attrs:{begin:g,size:b}});I=$({inputs:{x:e},backend:n,attrs:{shape:y}}),n.disposeIntermediateTensorInfo(e)}else if(y.some((e=>0===e)))I=n.makeTensorInfo(y,o.dtype,[]);else{const e=n.bufferSync(k),t=(0,Ur.t)(y,e,x,g);I=n.makeTensorInfo(t.shape,t.dtype,t.values)}const w=$({inputs:{x:I},backend:n,attrs:{shape:y}});return n.disposeIntermediateTensorInfo(k),n.disposeIntermediateTensorInfo(I),w}};var Pr=n(6841);const Br={kernelName:r._JP,backendName:"cpu",kernelFunc:
/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const{inputs:t,backend:n,attrs:r}=e,{separator:a,nGramWidths:s,leftPad:o,rightPad:i,padWidth:u,preserveShortSequences:l}=r,{data:c,dataSplits:d}=t,p=n.data.get(c.dataId).values,h=n.data.get(d.dataId).values,[f,m]=(0,Pr.A)(p,h,a,s,o,i,u,l);return[n.makeTensorInfo([f.length],"string",f),n.makeTensorInfo(d.shape,"int32",m)]}};var Lr=n(8639);const zr={kernelName:r.s1s,backendName:"cpu",kernelFunc:
/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const{inputs:t,backend:n,attrs:s}=e,{x:o,segmentIds:i}=t,{numSegments:u}=s;(0,a.H)(o,"unsortedSegmentSum");const l=[],c=[],d=o.shape.length-i.shape.length;let p=i;for(let e=0;e<d;++e){const t=ct({inputs:{input:p},backend:n,attrs:{dim:e+1}});p=t,c.push(t)}for(let e=0;e<u;++e){const t=r.D5U.createScalarValue(e,"int32"),a=n.makeTensorInfo([],"int32",t),s=(0,et.Dg)({inputs:{a,b:p},backend:n}),i=(0,he.p)({inputs:{x:s},backend:n,attrs:{dtype:"float32"}}),u=(0,qe.Jp)({inputs:{a:i,b:o},backend:n}),d=Ye({inputs:{x:u},backend:n,attrs:{axis:0,keepDims:!1}});l.push(d),c.push(a),c.push(s),c.push(i),c.push(u),c.push(d)}const h=Bn({inputs:l,backend:n,attrs:{axis:0}});return c.forEach((e=>n.disposeIntermediateTensorInfo(e))),h}},ua=[R,D.fC,F,O,S.j4,M,W,P,B,L,V,H,X,Z,J,re,ae,se,oe,N,ie,le,de,pe,he.M,fe.y2,ge,xe.z,be,Ce,Te,Ee,$e,Re,De,Ne,Fe,Oe,Me,Ue,We,Pe,Le,ze,Ve,Ge,He,Xe,je,mt,Qe,d,Je,et.Kx,ut,lt.SX,dt,pt.Vu,yt,It,wt,Ct.Ao,Tt,Et,Nt,Dt,Ft,_t.Ce,Ot.V,p.I,Mt,ke,Wt,Bt,zt,f,Vt.zh,Gt.m3,jt,Xt.xM,Kt,Qt,en,rn,an,sn,dn.eJ,pn,hn,fn,mn,gn,cn,xn,bn,vn.u0,yn,wn,Tn,qe.f$,En.AF,Rn,An,_n,On.nP,Mn,Pn,Ln,zn,Hn,b,jn.Iz,qn,Ie.O,Yn,y,I,T,Zn,Qn,Jn,er,tr,nr,ar,sr.FY,ir,ur,pr,w.BP,fr,gr,br,ue.C6,$n,kr,Ir,Cr,$r,Er,Nr,Rr,Dr,Ar.cz,Fr,_r.MS,Mr,Wr,Br,zr,Gr,gt.GR,Ze,jr,qr,Yr,Qr,U.b,Jr,sa,oa,ia,Wn];for(const e of ua)(0,r.wCN)(e)}
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * limitations under the License.
 * =============================================================================
 */function a(e,t,n,a){const s=r.D5U.parseAxisParam(t,n)[0],o=[1,n[0],1];for(let e=0;e<s;e++)o[0]*=n[e];o[1]=n[s];for(let e=s+1;e<n.length;e++)o[2]*=n[e];const i={},u=new Int32Array(n[s]),l=new r.YDk(o,a,e),c=[],d=1===o[0]&&1===o[2];for(let t=0;t<n[s];t++){let n;if(d)n=e[t].toString();else{const e=[];for(let n=0;n<o[0];n++)for(let r=0;r<o[2];r++)e.push(l.get(n,t,r));n=e.join(",")}if(void 0!==i[n])u[t]=i[n];else{const e=Object.keys(i).length;i[n]=e,u[t]=e,c.push(t)}}const p=o.slice();p[1]=Object.keys(i).length;const h=new r.YDk(p,a);c.forEach(((e,t)=>{for(let n=0;n<o[0];n++)for(let r=0;r<o[2];r++)h.set(l.get(n,e,r),n,t,r)}));const f=n.slice();return f[s]=p[1],{outputValues:h.values,outputShape:f,indices:u}}},5226:(e,t,n)=>{"use strict";n.r(t),n.d(t,{simpleAbsImpl:()=>r.bk,addImpl:()=>a.EH,bincountImpl:()=>s.W,bincountReduceImpl:()=>s.i,ceilImpl:()=>o.__,concatImpl:()=>i.j,equalImpl:()=>u.tW,expImpl:()=>l.Ro,expm1Impl:()=>c.OF,floorImpl:()=>d.r6,gatherNdImpl:()=>p.m,gatherV2Impl:()=>h.i,greaterImpl:()=>f.o,greaterEqualImpl:()=>m.HL,lessImpl:()=>g.rO,lessEqualImpl:()=>x.lx,linSpaceImpl:()=>b.b,logImpl:()=>v.vX,maxImpl:()=>y.B,maximumImpl:()=>k.wS,minimumImpl:()=>I.vP,multiplyImpl:()=>w.$3,negImpl:()=>C.uC,notEqualImpl:()=>S.Gj,prodImpl:()=>$.Qg,rangeImpl:()=>T.b,rsqrtImpl:()=>E.zd,sigmoidImpl:()=>N.VY,sliceImpl:()=>R.rT,sparseFillEmptyRowsImpl:()=>D.c,sparseReshapeImpl:()=>A.U,sparseSegmentReductionImpl:()=>F.V,sqrtImpl:()=>_.zT,squaredDifferenceImpl:()=>O.Hz,stridedSliceImpl:()=>M.t,stringNGramsImpl:()=>U.A,stringSplitImpl:()=>W.Q,stringToHashBucketFastImpl:()=>P.h,subImpl:()=>B.VY,tileImpl:()=>L.R,topKImpl:()=>z.W,transposeImpl:()=>V.H,uniqueImpl:()=>G.S});var r=n(224),a=n(2779),s=n(8607),o=n(4769),i=n(8926),u=n(7679),l=n(1211),c=n(969),d=n(6574),p=n(1820),h=n(4468),f=n(6272),m=n(6259),g=n(8405),x=n(635),b=n(1325),v=n(5223),y=n(5126),k=n(1717),I=n(612),w=n(1917),C=n(854),S=n(8584),$=n(9560),T=n(9230),E=n(7742),N=n(108),R=n(2578),D=n(2123),A=n(3849),F=n(3989),_=n(440),O=n(212),M=n(2210),U=n(6841),W=n(8639),P=n(6626),B=n(1649),L=n(7723),z=n(9556),V=n(7107),G=n(5638)}
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
class We{constructor(e){this.variableNames=["A"],this.outTexUsage=d.DOWNLOAD;const t=he();this.outputShape=e,this.userCode=`\n      ${be}\n\n      void main() {\n        float x = getAAtOutCoords();\n        ${t.output} = encode_float(x);\n      }\n    `}}
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
class Pe{constructor(e){this.variableNames=["A"],this.packedInputs=!0,this.packedOutput=!1,this.outTexUsage=d.DOWNLOAD;const t=he();this.outputShape=e,this.userCode=`\n      ${be}\n\n      void main() {\n        ivec3 coords = getOutputCoords();\n        float x = getChannel(getAAtOutCoords(), vec2(coords.y, coords.z));\n        ${t.output} = encode_float(x);\n      }\n    `}}
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
const Un="return areal * breal - aimag * bimag;",Wn="return areal * bimag + aimag * breal;";class Pn{constructor(e,t,n){this.variableNames=["AReal","AImag","BReal","BImag"],this.outputShape=s.Wap.assertAndGetBroadcastShape(t,n),this.userCode=`\n      float binaryOpComplex(\n          float areal, float aimag, float breal, float bimag) {\n        ${e}\n      }\n\n      void main() {\n        float areal = getARealAtOutCoords();\n        float aimag = getAImagAtOutCoords();\n        float breal = getBRealAtOutCoords();\n        float bimag = getBImagAtOutCoords();\n        setOutput(binaryOpComplex(areal, aimag, breal, bimag));\n      }\n    `}}
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const{inputs:t,backend:n,attrs:r}=e,{dy:a,input:o}=t,i=o,{filterSize:u,strides:l,pad:c,dimRoundingMode:d}=r,p=s.Wap.computePool3DInfo(i.shape,u,l,[1,1,1],c,d),h=new Pr(p);return n.runWebGLProgram(h,[a],i.dtype)}};const Lr={kernelName:s.ROF,backendName:"webgl",kernelFunc:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const{inputs:t,backend:n,attrs:r}=e,{dy:a,input:o}=t,i=o;de([a,o],"avgPoolGrad");const{filterSize:u,strides:l,pad:c}=r,d=s.Wap.computePool2DInfo(i.shape,u,l,1,c),p=new Wr(d);return n.runWebGLProgram(p,[a],i.dtype)}};const zr={kernelName:s.XLW,backendName:"webgl",kernelFunc:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
const Us={kernelName:s.eBW,backendName:"webgl",kernelFunc:function(e){const{inputs:t,backend:n,attrs:r}=e;let{pixels:a}=t;const{numChannels:o}=r,i="undefined"!=typeof HTMLVideoElement&&a instanceof HTMLVideoElement,u="undefined"!=typeof HTMLImageElement&&a instanceof HTMLImageElement,[l,c]=i?[a.videoWidth,a.videoHeight]:[a.width,a.height],p=[c,l],h=[c,l,o];(u||i)&&(null==Ws&&(Ws=document.createElement("canvas").getContext("2d")),Ws.canvas.width=l,Ws.canvas.height=c,Ws.drawImage(a,0,0,l,c),a=Ws.canvas);const f=n.makeTensorInfo(p,"int32");n.texData.get(f.dataId).usage=d.PIXELS,n.gpgpu.uploadPixelDataToTexture(n.getTexture(f.dataId),a);const m=(0,s.OBj)().getBool("WEBGL_PACK")?new Ms(h):new Os(h),g=n.runWebGLProgram(m,[f],"int32");return n.disposeData(f.dataId),g}};let Ws;const Ps={kernelName:s._V0,backendName:"webgl",kernelFunc:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const{inputs:t,backend:n}=e,{params:r,indices:a}=t,o=a.shape,i=o[o.length-1],u=s.D5U.sizeFromShape(r.shape),[l,c,d,p]=s.Wap.prepareAndValidate(r,a),h=Vn({inputs:{x:a},backend:n,attrs:{shape:[c,i]}}),f=Vn({inputs:{x:r},backend:n,attrs:{shape:[s.D5U.sizeFromShape(r.shape)/d,d]}});if(n.shouldExecuteOnCPU([r,a])||"string"===r.dtype){const e=n.readSync(a.dataId),t=n.bufferSync(r),s=kt(e,t,r.dtype,c,i,d,p,r.shape,u);return n.makeTensorInfo(l,r.dtype,s.values)}const m=new Ls(i,p,[c,d]),g=n.runWebGLProgram(m,[f,h],f.dtype),x=Vn({inputs:{x:g},backend:n,attrs:{shape:l}});return n.disposeIntermediateTensorInfo(h),n.disposeIntermediateTensorInfo(f),n.disposeIntermediateTensorInfo(g),x}};
/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
class Po{constructor(e,t,n){this.variableNames=["x"],this.outputShape=t.map(((t,n)=>t[0]+e[n]+t[1]));const r=e.length,a=Re(r),s=t.map((e=>e[0])).join(","),o=t.map(((t,n)=>t[0]+e[n])).join(","),i=["coords[0]","coords[1]","coords[2]","coords[3]"].slice(0,r),u="reflect"===n?0:1;this.userCode=1!==r?`\n      ${a} start = ${a}(${s});\n      ${a} end = ${a}(${o});\n\n      void main() {\n        ${a} outC = getOutputCoords();\n        for (int i = 0; i < ${r}; i++) {\n          if (outC[i] < start[i]) {\n            outC[i] = start[i] * 2 - outC[i] - ${u};\n          } else if(outC[i] >= end[i]) {\n            outC[i] = (end[i] - 1) * 2 - outC[i] + ${u};\n          }\n        }\n        ${a} coords = outC - start;\n        setOutput(getX(${i}));\n      }\n    `:`\n        int start = ${s};\n        int end = ${o};\n\n        void main() {\n          int outC = getOutputCoords();\n          if (outC < start) {\n            outC = start * 2 - outC - ${u};\n          } else if(outC >= end) {\n            outC = (end - 1) * 2 - outC + ${u};\n          }\n          setOutput(getX(outC - start));\n        }\n      `}}
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
const Lo={kernelName:s.jQs,backendName:"webgl",kernelFunc:({inputs:e,backend:t,attrs:n})=>{const{x:r}=e,{paddings:a,mode:o}=n,i=(0,s.OBj)().getBool("WEBGL_PACK_ARRAY_OPERATIONS")?new Bo(r.shape,a,o):new Po(r.shape,a,o);return t.runWebGLProgram(i,[r],r.dtype)}},zo=_n({opSnippet:"if (b == 0.0) return NAN;\n  return mod(a, b);",packedOpSnippet:"\n  vec4 result = mod(a, b);\n  vec4 isNaN = vec4(equal(b, vec4(0.0)));\n  \n  result.r = isNaN.r > 0. ? NAN : result.r;\n  result.g = isNaN.g > 0. ? NAN : result.g;\n  result.b = isNaN.b > 0. ? NAN : result.b;\n  result.a = isNaN.a > 0. ? NAN : result.a;\n\n  return result;\n"}),Vo={kernelName:s.Vbg,backendName:"webgl",kernelFunc:zo};
/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
class Wi{constructor(e,t){this.variableNames=["x"];const n=e.length;if(n>4)throw new Error(`WebGL backend: Reverse of rank-${n} tensor is not yet supported`);if(this.outputShape=e,1===n)return void(this.userCode=`\n        void main() {\n          int coord = getOutputCoords();\n          setOutput(getX(${e[0]} - coord - 1));\n        }\n      `);const r=e.map(((n,r)=>(n=>-1!==t.indexOf(n)&&1!==e[n]?`${e[n]} - coords[${n}] - 1`:`coords[${n}]`)(r))).join(","),a=Re(n);this.userCode=`\n      void main() {\n        ${a} coords = getOutputCoords();\n        setOutput(getX(${r}));\n      }\n    `}}
/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const{inputs:t,backend:n,attrs:r}=e,{x:a}=t,{dims:o}=r,i=a.shape.length,u=s.D5U.parseAxisParam(o,a.shape);if(0===i)return wn({inputs:{x:a},backend:n});const l=(0,s.OBj)().getBool("WEBGL_PACK_ARRAY_OPERATIONS")?new Pi(a.shape,u):new Wi(a.shape,u);return n.runWebGLProgram(l,[a],a.dtype)}};
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const{inputs:t,backend:n,attrs:r}=e,{x:a}=t,{numOrSizeSplits:o,axis:i}=r,u=s.D5U.parseAxisParam(i,a.shape)[0],l=s.Wap.prepareSplitSize(a,o,u),c=a.shape.length,d=new Array(c).fill(0),p=a.shape.slice();return l.map((e=>{const t=[...p];t[u]=e;const r=Kr({inputs:{x:a},backend:n,attrs:{begin:d,size:t}});return d[u]+=e,r}))}},xu="return sqrt(x);",bu=Fn({opSnippet:xu,packedOpSnippet:xu,cpuKernelImpl:Gt}),vu={kernelName:s.FKq,backendName:"webgl",kernelFunc:bu},yu=Fn({opSnippet:"return x * x;"}),ku={kernelName:s.bK0,backendName:"webgl",kernelFunc:yu},Iu="return (a - b) * (a - b);",wu=_n({opSnippet:Iu,packedOpSnippet:Iu}),Cu={kernelName:s._tC,backendName:"webgl",kernelFunc:wu};const Su={kernelName:s.h8e,backendName:"webgl",kernelFunc:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const{inputs:t,backend:n,attrs:r}=e,{x:a}=t,{begin:o,end:i,strides:u,beginMask:l,endMask:c,ellipsisMask:d,newAxisMask:p,shrinkAxisMask:h}=r,{nonStrided:f,$begin:m,$strides:g,size:x,newShape:b,outShape:v}=s.kuN.sliceInfo(a.shape,o,i,u,l,c,d,p,h),y=Vn({inputs:{x:a},backend:n,attrs:{shape:b}});let k;if(f){const e=Kr({inputs:{x:y},backend:n,attrs:{begin:m,size:x}});k=Vn({inputs:{x:e},backend:n,attrs:{shape:v}}),n.disposeIntermediateTensorInfo(e)}else if(v.some((e=>0===e)))k=n.makeTensorInfo(v,a.dtype,[]);else{if(n.shouldExecuteOnCPU([y])){const e=n.texData.get(y.dataId).values,t=(0,s.f3b)(y.shape,y.dtype,e),r=Ht(v,t,g,m);k=n.makeTensorInfo(v,y.dtype,r.values)}else{const e=new $u(m,g,v);k=n.runWebGLProgram(e,[y],y.dtype)}}const I=Vn({inputs:{x:k},backend:n,attrs:{shape:v}});return n.disposeIntermediateTensorInfo(y),n.disposeIntermediateTensorInfo(k),I}};const Eu={kernelName:s._JP,backendName:"webgl",kernelFunc:
/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
class Xu{constructor(e,t){this.variableNames=["x","segmentIds"];const n=e.windowSize,r=e.batchSize,a=e.inSize,s=e.numSegments,o=s*Math.ceil(a/n);this.outputShape=[r,o];const i=4*Math.floor(n/4),u=n%4,l="\n        sumValue += dot(values, segFilter);\n    ";let c="";a%n>0&&(c=`\n        if (inIdx < 0 || inIdx >= ${a}) {\n          return initializationValue;\n        }\n      `);let d="";a%n>0&&(d=`\n        if (inIdx < 0 || inIdx >= ${a}) {\n          return -1.0;\n        }\n      `),this.userCode=`\n      const float initializationValue = 0.0;\n\n      float getValue(int batch, int inIdx) {\n        ${c}\n        return getX(batch, inIdx);\n      }\n\n      float getSegmentIdAtIndex(int inIdx) {\n        ${d}\n        return getSegmentIds(inIdx);\n      }\n\n      void main() {\n        ivec2 coords = getOutputCoords();\n        int batch = coords[0];\n        int outIdx = coords[1];\n        int inOffset = int(floor(float(outIdx) / float(\n          ${s})) * float(${n}));\n        int currentSeg = int(mod(float(outIdx), float(${s})));\n\n        float sumValue = 0.0;\n\n        for (int i = 0; i < ${i}; i += 4) {\n          int inIdx = inOffset + i;\n          vec4 values = vec4(\n            getValue(batch, inIdx),\n            getValue(batch, inIdx + 1),\n            getValue(batch, inIdx + 2),\n            getValue(batch, inIdx + 3)\n          );\n\n          vec4 segFilter = vec4(\n            int(getSegmentIdAtIndex(inIdx)) == currentSeg ? 1 : 0,\n            int(getSegmentIdAtIndex(inIdx + 1)) == currentSeg ? 1 : 0,\n            int(getSegmentIdAtIndex(inIdx + 2)) == currentSeg ? 1 : 0,\n            int(getSegmentIdAtIndex(inIdx + 3)) == currentSeg ? 1 : 0\n          );\n\n          ${l}\n        }\n\n        int inIdx = inOffset + ${i};\n        if (${1===u}) {\n          vec4 values = vec4(\n            getValue(batch, inIdx),\n            initializationValue,\n            initializationValue,\n            initializationValue\n          );\n\n          int inIdxSeg = int(getSegmentIdAtIndex(inIdx));\n\n          vec4 segFilter = vec4(\n            int(getSegmentIdAtIndex(inIdx)) == currentSeg ? 1 : 0,\n            0,\n            0,\n            0\n          );\n\n          ${l}\n        } else if (${2===u}) {\n          vec4 values = vec4(\n            getValue(batch, inIdx),\n            getValue(batch, inIdx + 1),\n            initializationValue,\n            initializationValue\n          );\n\n          vec4 segFilter = vec4(\n            int(getSegmentIdAtIndex(inIdx)) == currentSeg ? 1 : 0,\n            int(getSegmentIdAtIndex(inIdx + 1)) == currentSeg ? 1 : 0,\n              0,\n              0\n          );\n\n          ${l}\n        } else if (${3===u}) {\n          vec4 values = vec4(\n            getValue(batch, inIdx),\n            getValue(batch, inIdx + 1),\n            getValue(batch, inIdx + 2),\n            initializationValue\n          );\n\n          vec4 segFilter = vec4(\n            int(getSegmentIdAtIndex(inIdx)) == currentSeg ? 1 : 0,\n            int(getSegmentIdAtIndex(inIdx + 1)) == currentSeg ? 1 : 0,\n            int(getSegmentIdAtIndex(inIdx + 2)) == currentSeg ? 1 : 0,\n            0\n          );\n\n          ${l}\n        }\n        setOutput(sumValue);\n      }\n    `}}const qu=[ko,wo,nr,ar,or,ur,dr,fr,mr,gr,Ir,wr,Sr,Tr,Dr,Nr,Fr,Ur,Mr,Br,Lr,zr,Hr,Zr,Qr,ra,oa,la,pa,$n,ya,Da,Aa,$a,_a,Oa,Fa,Ua,Pa,La,Ha,ja,qa,es,ts,Za,rs,ss,os,us,ls,ds,hs,gs,bs,ks,Cs,Ts,Ns,As,_s,Us,Ps,Bs,zs,Hs,Xs,Ks,Cn,Ys,xa,Qs,eo,no,Nn,ao,oo,io,po,lo,fo,go,bo,So,No,Eo,Ao,Fo,_o,To,Oo,Mo,Wo,Lo,Vo,Qo,zn,ei,ni,ai,oi,ea,ui,di,pi,gi,bi,An,vi,ki,na,jo,wi,Ti,Si,Gn,Ri,Ai,Oi,Ui,Bi,zi,Gi,ji,qi,Yi,Qi,tu,ru,su,iu,Yr,Zo,lu,cu,du,pu,hu,fu,mu,gu,vu,ku,Cu,Su,Tu,Eu,Nu,Ru,Ko,Qn,Au,_u,Uu,zu,Gu,er,Hu,ju,{kernelName:s.Qvg,backendName:"webgl",kernelFunc:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
const Ja="://";class es{constructor(){this.managers={}}static getInstance(){return null==es.instance&&(es.instance=new es),es.instance}static registerManager(e,t){y(null!=e,(()=>"scheme must not be undefined or null.")),e.endsWith(Ja)&&(e=e.slice(0,e.indexOf(Ja))),y(e.length>0,(()=>"scheme must not be an empty string."));const n=es.getInstance();y(null==n.managers[e],(()=>`A model store manager is already registered for scheme '${e}'.`)),n.managers[e]=t}static getManager(e){const t=this.getInstance().managers[e];if(null==t)throw new Error(`Cannot find model manager for scheme '${e}'`);return t}static getSchemes(){return Object.keys(this.getInstance().managers)}}
/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
class ts{fetch(e,t){return fetch(e,t)}now(){return performance.now()}encode(e,t){if("utf-8"!==t&&"utf8"!==t)throw new Error(`Browser's encoder only supports utf-8, but got ${t}`);return null==this.textEncoder&&(this.textEncoder=new TextEncoder),this.textEncoder.encode(e)}decode(e,t){return new TextDecoder(t).decode(e)}}if(de().get("IS_BROWSER")){de().setPlatform("browser",new ts);try{es.registerManager(Ya.URL_SCHEME,new Qa)}catch(e){}try{es.registerManager(Ua.URL_SCHEME,new Pa)}catch(e){}}
/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){const n=ls(e,"x","cast");if(!P(t))throw new Error(`Failed to cast to unknown dtype ${t}`);if("string"===t&&"string"!==n.dtype||"string"!==t&&"string"===n.dtype)throw new Error("Only strings can be casted to strings");const r={x:n},a={dtype:t};return ka.runKernel(We,r,a)}});const hs=ds({clone_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t={x:ls(e,"x","clone","string_or_numeric")};return ka.runKernel(Et,t)}});
/**
 * @license
 * Copyright 2020 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
ya();na={buffer:ss,cast:ps,clone:hs,print:
/**
 * @license
 * Copyright 2020 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function gs(e,t,n,r){!function(e){y(null!=e&&Array.isArray(e)&&e.length>0,(()=>"promises must be a none empty array"))}(e),function(e,t){y(e>=0&&e<=1,(()=>`Progress fraction must be in range [0, 1], but got startFraction ${e}`)),y(t>=0&&t<=1,(()=>`Progress fraction must be in range [0, 1], but got endFraction ${t}`)),y(t>=e,(()=>`startFraction must be no more than endFraction, but got startFraction ${e} and endFraction ${t}`))}(n=null==n?0:n,r=null==r?1:r);let a=0;return Promise.all(e.map((s=>(s.then((s=>{const o=n+ ++a/e.length*(r-n);return t(o),s})),s))))}
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function Ws(e,t,n,r){if(null==r&&(r=X(e)),"complex64"===r)throw new Error("Cannot construct a complex64 tensor directly. Please use tf.complex(real, imag).");if(!L(e)&&!Array.isArray(e)&&"number"!=typeof e&&"boolean"!=typeof e&&"string"!=typeof e)throw new Error("values passed to tensor(values) must be a number/boolean/string or an array of numbers/booleans/strings, or a TypedArray");if(null!=t){ne(t);const e=C(t),r=C(n);y(e===r,(()=>`Based on the provided shape, [${t}], the tensor should have ${e} values but has ${r}`));for(let e=0;e<n.length;++e){const r=n[e],a=e!==n.length-1||r!==C(t.slice(e));y(n[e]===t[e]||!a,(()=>`Error creating a new Tensor. Inferred shape (${n}) does not match the provided shape (${t}). `))}}return L(e)||Array.isArray(e)||(e=[e]),t=t||n,e="string"!==r?Lr(e,r):w(e,[],!0),ka.makeTensor(e,t,r)}
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function Ps(e,t){if((L(e)&&"string"!==t||Array.isArray(e))&&"complex64"!==t)throw new Error("Error creating a new Scalar: value must be a primitive (number|boolean|string)");if("string"===t&&L(e)&&!(e instanceof Uint8Array))throw new Error("When making a scalar from encoded string, the value must be `Uint8Array`.");return Ws(e,[],[],t)}const Bs=ds({complex_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){const n=ls(e,"real","complex"),r=ls(t,"imag","complex");k(n.shape,r.shape,`real and imag shapes, ${n.shape} and ${r.shape}, must match in call to tf.complex().`);const a={real:n,imag:r};return ka.runKernel(Le,a)}});
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function Ls(e,t="float32"){if("complex64"===t){const t=Ls(e,"float32"),n=Ls(e,"float32");return Bs(t,n)}const n=ee(C(e),t);return ka.makeTensor(n,e,t)}const zs=ds({concat_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t=0){y(e.length>=1,(()=>"Pass at least one tensor to concat"));const n=cs(e,"tensors","concat","string_or_numeric");if("complex64"===n[0].dtype&&n.forEach((e=>{if("complex64"!==e.dtype)throw new Error(`Cannot concatenate complex64 tensors with a tensor\n          with dtype ${e.dtype}. `)})),1===n.length)return hs(n[0]);const r=n,a={axis:t};return ka.runKernel(Ve,r,a)}});const Vs=ds({imag_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t={input:ls(e,"input","imag")};return ka.runKernel(Rt,t)}});const Gs=ds({real_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t={input:ls(e,"input","real")};return ka.runKernel(vn,t)}});const Hs=ds({reshape_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){const n={x:ls(e,"x","reshape","string_or_numeric")},r={shape:t};return ka.runKernel(In,n,r)}});const js=ds({slice_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t,n){const r=ls(e,"x","slice","string_or_numeric");if(0===r.rank)throw new Error("Slicing scalar is not possible");const a={x:r},s={begin:t,size:n};return ka.runKernel(_n,a,s)}});const Xs=ds({split_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t,n=0){const r={x:ls(e,"x","split")},a={numOrSizeSplits:t,axis:n};return ka.runKernel(Vn,r,a)}});const qs=ds({zerosLike_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t={x:ls(e,"x","zerosLike")};return ka.runKernel(pr,t)}});const Ks=ds({fft_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){y("complex64"===e.dtype,(()=>`The dtype for tf.spectral.fft() must be complex64 but got ${e.dtype}.`));const t={input:e};return ka.runKernel(bt,t)}});const Ys=ds({rfft_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){y("complex64"===e.dtype,(()=>`The dtype for tf.spectral.ifft() must be complex64 but got ${e.dtype}.`));const t={input:e};return ka.runKernel(Nt,t)}});const Qs=ds({mul_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){let n=ls(e,"a","mul"),r=ls(t,"b","mul");[n,r]=fa(n,r);const a={a:n,b:r};return ka.runKernel(an,a)}});const Js=ds({reverse_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){const n={x:ls(e,"x","reverse")},r={dims:t};return ka.runKernel(En,n,r)}});ds({irfft_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t=e.shape[e.shape.length-1],n=e.size/t;let r;if(t<=2){const a=Hs(e,[n,t]);r=Zs(a)}else{const a=[n,2*(t-1)],s=Hs(Gs(e),[n,t]),o=Hs(Vs(e),[n,t]),i=Js(js(s,[0,1],[n,t-2]),1),u=Qs(Js(js(o,[0,1],[n,t-2]),1),Ps(-1)),l=zs([s,i],1),c=zs([o,u],1),d=Hs(Bs(l,c),[a[0],a[1]]);r=Zs(d)}if(r=Gs(r),3===e.rank&&0!==e.shape[0]){const t=r,n=e.shape[0];r=Hs(r,[n,r.shape[0]/n,r.shape[1]]),t.dispose()}return r}});
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function eo(e,t){I(e);const n=os(e,t);if(1!==n.length)throw new Error("tensor1d() requires values to be a flat/TypedArray");return Ws(e,null,n,t)}function to(e,t,n){const r=1-e%2,a=new Float32Array(e);for(let s=0;s<e;++s){const o=2*Math.PI*s/(e+r-1);a[s]=t-n*Math.cos(o)}return eo(a,"float32")}ds({hammingWindow_:
/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function ro(e,t,n){const r={shape:e,value:t,dtype:n};return ka.runKernel(vt,{},r)}
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t=ls(e,"image","flipLeftRight","float32");y(4===t.rank,(()=>`Error in flipLeftRight: image must be rank 4,but got rank ${t.rank}.`));const n={image:t};return ka.runKernel(yt,n,{})}});const oo=ds({tile_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){const n=ls(e,"x","tile","string_or_numeric");y(n.rank===t.length,(()=>`Error in transpose: rank of input ${n.rank} must match length of reps ${t}.`));const r={x:n},a={reps:t};return ka.runKernel(sr,r,a)}});ds({grayscaleToRGB_:
/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t,n=0,r=.5){const a=ls(e,"image","rotateWithOffset","float32");y(4===a.rank,(()=>`Error in rotateWithOffset: image must be rank 4,but got rank ${a.rank}.`));const s={image:a},o={radians:t,fillValue:n,center:r};return ka.runKernel(mr,s,o)}});
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t,n,r=.5,a=Number.NEGATIVE_INFINITY){const s=ls(e,"boxes","nonMaxSuppression"),o=ls(t,"scores","nonMaxSuppression"),i=io(s,o,n,r,a),u={maxOutputSize:n=i.maxOutputSize,iouThreshold:r=i.iouThreshold,scoreThreshold:a=i.scoreThreshold};return ka.runKernel(un,{boxes:s,scores:o},u)}});
/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t,n,r=.5,a=Number.NEGATIVE_INFINITY,s=0){const o=ls(e,"boxes","nonMaxSuppression"),i=ls(t,"scores","nonMaxSuppression"),u=io(o,i,n,r,a,s),l={boxes:o,scores:i},c={maxOutputSize:n=u.maxOutputSize,iouThreshold:r=u.iouThreshold,scoreThreshold:a=u.scoreThreshold,softNmsSigma:s=u.softNmsSigma},d=ka.runKernel(cn,l,c);return{selectedIndices:d[0],selectedScores:d[1]}}});ds({nonMaxSuppressionPadded_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t,n,r=.5,a=Number.NEGATIVE_INFINITY,s=!1){const o=ls(e,"boxes","nonMaxSuppression"),i=ls(t,"scores","nonMaxSuppression"),u=io(o,i,n,r,a,null),l={boxes:o,scores:i},c={maxOutputSize:u.maxOutputSize,iouThreshold:u.iouThreshold,scoreThreshold:u.scoreThreshold,padToMaxOutputSize:s},d=ka.runKernel(ln,l,c);return{selectedIndices:d[0],validOutputs:d[1]}}});ds({resizeBilinear_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t,n=!1,r=!1){const a=ls(e,"images","resizeBilinear");y(3===a.rank||4===a.rank,(()=>`Error in resizeBilinear: x must be rank 3 or 4, but got rank ${a.rank}.`)),y(2===t.length,(()=>`Error in resizeBilinear: new shape must 2D, but got shape ${t}.`)),y(!1===r||!1===n,(()=>"Error in resizeBilinear: If halfPixelCenters is true, alignCorners must be false."));let s=a,o=!1;3===a.rank&&(o=!0,s=Hs(a,[1,a.shape[0],a.shape[1],a.shape[2]]));const[]=t,i={images:s},u={alignCorners:n,halfPixelCenters:r,size:t},l=ka.runKernel(Sn,i,u);return o?Hs(l,[l.shape[1],l.shape[2],l.shape[3]]):l}});ds({resizeNearestNeighbor_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t,n){const r=ls(e,"x","bincount"),a=ls(t,"weights","bincount");y("int32"===r.dtype,(()=>`Error in bincount: input dtype must be int32, but got ${r.dtype}`)),y(n>=0,(()=>`size must be non-negative, but got ${n}.`)),y(a.size===r.size||0===a.size,(()=>`Error in bincount: weights must have the same size as input or0-length, but got input shape: ${r.shape}, weights shape: ${a.shape}.`));const s={x:r,weights:a},o={size:n};return ka.runKernel(Me,s,o)}});
/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function vo(e,t){const n=e.length,r=[];for(let a=0;a<n;a++){const s=n-1-a,o=e[s]||1;(t[t.length-1-a]||1)>1&&1===o&&r.unshift(s)}return r}function yo(e,t){const n=[];for(let r=0;r<t.length;r++){const a=e[e.length-r-1],s=t.length-r-1,o=t[s];(null==a||1===a&&o>1)&&n.unshift(s)}return n}function ko(e,t){const n=[],r=Math.max(e.length,t.length);for(let a=0;a<r;a++){let r=e[e.length-a-1];null==r&&(r=1);let s=t[t.length-a-1];if(null==s&&(s=1),1===r)n.unshift(s);else if(1===s)n.unshift(r);else{if(r!==s){throw Error(`Operands could not be broadcast together with shapes ${e} and ${t}.`)}n.unshift(r)}}return n}const Io=ds({lessEqual_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){let n=ls(e,"a","lessEqual","string_or_numeric"),r=ls(t,"b","lessEqual","string_or_numeric");[n,r]=fa(n,r),ko(n.shape,r.shape);const a={a:n,b:r};return ka.runKernel(Mt,a)}});const wo=ds({greater_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){let n=ls(e,"a","greater","string_or_numeric"),r=ls(t,"b","greater","string_or_numeric");[n,r]=fa(n,r),ko(n.shape,r.shape);const a={a:n,b:r};return ka.runKernel($t,a)}});const Co=ds({sum_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t=null,n=!1){let r=ls(e,"x","sum");"bool"===r.dtype&&(r=ps(r,"int32"));const a={x:r},s={axis:t,keepDims:n};return ka.runKernel(Ln,a,s)}});const So=ds({add_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){let n=ls(e,"a","add"),r=ls(t,"b","add");[n,r]=fa(n,r);const a={a:n,b:r};return ka.runKernel(ve,a)}});const $o=ds({floorDiv_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){let n=ls(e,"a","floorDiv"),r=ls(t,"b","floorDiv");[n,r]=fa(n,r);const a={a:n,b:r};return ka.runKernel(It,a)}});const To=ds({div_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){let n=ls(e,"a","div"),r=ls(t,"b","div");if([n,r]=fa(n,r),"int32"===n.dtype&&"int32"===r.dtype)return $o(n,r);const a={a:n,b:r};return ka.runKernel(lt,a,{})}});const Eo=ds({sub_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){let n=ls(e,"a","sub"),r=ls(t,"b","sub");[n,r]=fa(n,r);const a={a:n,b:r};return ka.runKernel(nr,a)}});const No=ds({round_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t={x:ls(e,"x","round")};return ka.runKernel(Nn,t)}});const Ro=ds({broadcastTo_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t,n){const r=ls(t,"a","where"),a=ls(n,"b","where"),s=ls(e,"condition","where","bool"),o=ko(ko(s.shape,r.shape),a.shape),i={condition:Ro(s,o),t:Ro(r,o),e:Ro(a,o)};return ka.runKernel(An,i)}});
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function Ao(e,t,n=1,r="float32"){if(0===n)throw new Error("Cannot have a step of zero");const a={start:e,stop:t,step:n,dtype:r};return ka.runKernel(bn,{},a)}ds({threshold_:
/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t="binary",n=!1,r=.5){const a=ls(e,"image","threshold"),s=a.shape[0]*a.shape[1];let o,i,u,l,c=Qs(eo([r]),255);if(y(3===a.rank,(()=>`Error in threshold: image must be rank 3,but got rank ${a.rank}.`)),y(3===a.shape[2]||1===a.shape[2],(()=>`Error in threshold: image color channel must be equal to 3 or 1but got ${a.shape[2]}.`)),y("int32"===a.dtype||"float32"===a.dtype,(()=>`Error in dtype: image dtype must be int32 or float32,but got dtype ${a.dtype}.`)),y("otsu"===t||"binary"===t,(()=>`Method must be binary or otsu, but was ${t}`)),3===a.shape[2]){[o,i,u]=Xs(a,[1,1,1],-1);const e=Qs(o,.2989),t=Qs(i,.587),n=Qs(u,.114);l=So(So(e,t),n)}else l=e;if("otsu"===t){c=function(e,t){let n,r,a,s,o,i,u=eo([-1]),l=eo([0]),c=eo([0]);for(let d=0;d<e.size-1;d++){n=js(e,0,d+1),r=js(e,d+1),o=To(Co(n),t),i=To(Co(r),t);const p=Co(Qs(n,Ao(0,n.size)));a=To(p,Co(n));const h=ro(r.shape,n.size),f=So(Ao(0,r.size),h),m=Qs(r,f);s=To(Co(m),Co(r));const g=Eo(a,s),x=Eo(a,s),b=Qs(o,i);c=Qs(Qs(b,g),x);const v=wo(c,l);l=Do(v,c,l),u=Do(v,eo([d]),u)}return u}(bo(ps(No(l),"int32"),Ws(d=[],p,os(d,h),h),256),s)}
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){let n=ls(e,"a","greaterEqual","string_or_numeric"),r=ls(t,"b","greaterEqual","string_or_numeric");[n,r]=fa(n,r),ko(n.shape,r.shape);const a={a:n,b:r};return ka.runKernel(Tt,a)}});const _o=ds({logicalAnd_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){const n=ls(e,"a","logicalAnd","bool"),r=ls(t,"b","logicalAnd","bool");ko(n.shape,r.shape);const a={a:n,b:r};return ka.runKernel(Bt,a)}});const Oo=ds({stack_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t=0){const n=cs(e,"tensors","stack","string_or_numeric");y(n.length>=1,(()=>"Pass at least one tensor to tf.stack")),n.length>0&&y(t<=n[0].rank,(()=>"Axis must be <= rank of the tensor"));const r=n,a={axis:t};return ka.runKernel(hn,r,a)}});const Mo=ds({unstack_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t=0){const n=ls(e,"x","unstack","string_or_numeric");y(t>=-n.shape.length&&t<n.shape.length,(()=>`Axis = ${t} is not in [-${n.shape.length}, ${n.shape.length})`));const r={value:n},a={axis:t};return ka.runKernel(cr,r,a)}});ds({bandPart_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t,n){y(t%1==0,(()=>`bandPart(): numLower must be an integer, got ${t}.`)),y(n%1==0,(()=>`bandPart(): numUpper must be an integer, got ${n}.`));const r=ls(e,"a","bandPart");y(r.rank>=2,(()=>`bandPart(): Rank must be at least 2, got ${r.rank}.`));const a=r.shape,[s,o]=r.shape.slice(-2);if(!(t<=s))throw new Error(`bandPart(): numLower (${t}) must not be greater than the number of rows (${s}).`);if(!(n<=o))throw new Error(`bandPart(): numUpper (${n}) must not be greater than the number of columns (${o}).`);t<0&&(t=s),n<0&&(n=o);const i=Hs(Ao(0,s,1,"int32"),[-1,1]),u=Ao(0,o,1,"int32"),l=Eo(i,u),c=_o(Io(l,Ps(+t,"int32")),Fo(l,Ps(-n,"int32"))),d=Ls([s,o],r.dtype);return Hs(Oo(Mo(Hs(r,[-1,s,o])).map((e=>Do(c,e,d)))),a)}});const Uo=ds({abs_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t=ls(e,"x","abs");if("complex64"===t.dtype){const e={x:t};return ka.runKernel(ze,e)}{const e={x:t};return ka.runKernel(ge,e)}}});
/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function Wo(e,t){for(let n=0;n<e.length;++n)if(e[e.length-n-1]!==t-1-n)return!1;return!0}function Po(e,t,n){const r=e.length+t.length,a=[];let s=0,o=0;for(let i=0;i<r;i++)-1===n.indexOf(i)?a.push(e[s++]):a.push(t[o++]);return a}function Bo(e,t){const n=[],r=e.length;for(let a=0;a<r;a++)-1===t.indexOf(a)&&n.push(e[a]);return[n,t.map((t=>e[t]))]}function Lo(e,t){return Po(e,t.map((e=>1)),t)}function zo(e,t,n){y(Wo(t,n),(()=>`${e} supports only inner-most axes for now. Got axes ${t} and rank-${n} input.`))}function Vo(e,t){if(Wo(e,t))return null;const n=[];for(let r=0;r<t;++r)-1===e.indexOf(r)&&n.push(r);return e.forEach((e=>n.push(e))),n}function Go(e){return e.map(((e,t)=>[t,e])).sort(((e,t)=>e[1]-t[1])).map((e=>e[0]))}function Ho(e,t){const n=[];for(let r=t-e;r<t;++r)n.push(r);return n}const jo=ds({max_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t=null,n=!1){const r={x:ls(e,"x","max")},a={reductionIndices:t,keepDims:n};return ka.runKernel(Ht,r,a)}});const Xo=ds({min_:
/**
 * @license
 * Copyright 2020 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t=null,n=!1){const r={x:ls(e,"x","min")},a={axis:t,keepDims:n};return ka.runKernel(Jt,r,a)}});const qo=ds({pow_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){let n=ls(e,"base","pow"),r=ls(t,"exp","pow");[n,r]=fa(n,r);const a={a:n,b:r};return ka.runKernel(mn,a)}});const Ko=ds({sqrt_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t={x:ls(e,"x","sqrt")};return ka.runKernel(Bn,t)}});const Yo=ds({square_:
/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t=ls(e,"x","square");return ka.runKernel("Square",{x:t},{})}});function Zo(e,t,n=null){if(0===e.rank)return Uo(e);if(1!==e.rank&&null===n)return Zo(Hs(e,[-1]),t,n);if(1===e.rank||"number"==typeof n||Array.isArray(n)&&1===n.length){if(1===t)return Co(Uo(e),n);if(t===1/0)return jo(Uo(e),n);if(t===-1/0)return Xo(Uo(e),n);if("euclidean"===t||2===t)return Ko(Co(qo(Uo(e),Ps(2,"int32")),n));throw new Error(`Error in norm: invalid ord value: ${t}`)}if(Array.isArray(n)&&2===n.length){if(1===t)return jo(Co(Uo(e),n[0]),n[1]-1);if(t===1/0)return jo(Co(Uo(e),n[1]),n[0]);if(t===-1/0)return Xo(Co(Uo(e),n[1]),n[0]);if("fro"===t||"euclidean"===t)return Ko(Co(Yo(e),n));throw new Error(`Error in norm: invalid ord value: ${t}`)}throw new Error(`Error in norm: invalid axis: ${n}`)}const Qo=ds({norm_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){let t;if(Array.isArray(e)){t=!1,y(null!=e&&e.length>0,(()=>"Gram-Schmidt process: input must not be null, undefined, or empty"));const n=e[0].shape[0];for(let t=1;t<e.length;++t)y(e[t].shape[0]===n,(()=>`Gram-Schmidt: Non-unique lengths found in the input vectors: (${e[t].shape[0]} vs. ${n})`))}else t=!0,e=Xs(e,e.shape[0],0).map((e=>Jo(e,[0])));y(e.length<=e[0].shape[0],(()=>`Gram-Schmidt: Number of vectors (${e.length}) exceeds number of dimensions (${e[0].shape[0]}).`));const n=[],r=e;for(let t=0;t<e.length;++t)n.push(ka.tidy((()=>{let e=r[t];if(t>0)for(let r=0;r<t;++r){const t=Qs(Co(Qs(n[r],e)),n[r]);e=Eo(e,t)}return To(e,Qo(e,"euclidean"))})));return t?Oo(n,0):n}});function ei(){return ka}function ti(e,t){return ka.tidy(e,t)}function ni(e,t,n=1){return ka.registerBackend(e,t,n)}ra=function(e){de().getBool("DEPRECATION_WARNINGS_ENABLED")&&console.warn(e+" You can disable deprecation warnings with tf.disableDeprecationWarnings().")};const ri=ds({expandDims_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t=0){const n=ls(e,"x","expandDims","string_or_numeric");y(t<=n.rank,(()=>"Axis must be <= rank of the tensor"));const r={input:n},a={dim:t};return ka.runKernel(gt,r,a)}});const ai=ds({eye_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t,n=!1,r=!1){let a=ls(e,"a","matMul"),s=ls(t,"b","matMul");[a,s]=fa(a,s);const o={a,b:s},i={transposeA:n,transposeB:r};return ka.runKernel(_e,o,i)}});const oi=ds({neg_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t={x:ls(e,"x","neg")};return ka.runKernel(sn,t)}});const ii=ds({transpose_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t=!1){if(y(e.rank>=2,(()=>`qr() requires input tensor to have a rank >= 2, but got rank ${e.rank}`)),2===e.rank)return ui(e,t);{const n=e.shape.slice(0,e.shape.length-2).reduce(((e,t)=>e*t)),r=Mo(Hs(e,[n,e.shape[e.shape.length-2],e.shape[e.shape.length-1]]),0),a=[],s=[];r.forEach((e=>{const[n,r]=ui(e,t);a.push(n),s.push(r)}));return[Hs(Oo(a,0),e.shape),Hs(Oo(s,0),e.shape)]}}});
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t=null,n=!1){const r={x:ls(e,"x","mean")},a={axis:t,keepDims:n};return ka.runKernel(Qt,r,a)}});const di=ds({notEqual_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){let n=ls(e,"a","notEqual","string_or_numeric"),r=ls(t,"b","notEqual","string_or_numeric");[n,r]=fa(n,r),ko(n.shape,r.shape);const a={a:n,b:r};return ka.runKernel(on,a)}});
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function pi(e,t="float32"){if("complex64"===t){const t=pi(e,"float32"),n=Ls(e,"float32");return Bs(t,n)}const n=J(C(e),t);return ka.makeTensor(n,e,t)}const hi=ds({computeWeightedLoss_:function(e,t,n=li.SUM_BY_NONZERO_WEIGHTS){const r=ls(e,"losses","computeWeightedLoss");let a=null;null!=t&&(a=ls(t,"weights","computeWeightedLoss"));const s=null==a?r:Qs(r,a);if(n===li.NONE)return s;if(n===li.SUM)return Co(s);if(n===li.MEAN){if(null==a)return ci(s);{const e=r.size/a.size,t=To(Co(s),Co(a));return e>1?To(t,Ps(e)):t}}if(n===li.SUM_BY_NONZERO_WEIGHTS){if(null==a)return To(Co(s),Ps(r.size));{const e=Qs(a,pi(r.shape)),t=ps(Co(di(e,Ps(0))),"float32");return To(Co(s),t)}}throw Error(`Unknown reduction: ${n}`)}});ds({absoluteDifference_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t,n,r=li.SUM_BY_NONZERO_WEIGHTS){const a=ls(e,"labels","absoluteDifference"),s=ls(t,"predictions","absoluteDifference");let o=null;null!=n&&(o=ls(n,"weights","absoluteDifference")),k(a.shape,s.shape,"Error in absoluteDifference: ");const i=Uo(Eo(a,s));return hi(i,o,r)}});ds({cosineDistance_:function(e,t,n,r,a=li.SUM_BY_NONZERO_WEIGHTS){const s=ls(e,"labels","cosineDistance"),o=ls(t,"predictions","cosineDistance");let i=null;null!=r&&(i=ls(r,"weights","cosineDistance")),k(s.shape,o.shape,"Error in cosineDistance: ");const u=Ps(1),l=Eo(u,Co(Qs(s,o),n,!0));return hi(l,i,a)}});const fi=ds({relu_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t={x:ls(e,"x","relu")};return ka.runKernel(kn,t)}});ds({hingeLoss_:function(e,t,n,r=li.SUM_BY_NONZERO_WEIGHTS){let a=ls(e,"labels","hingeLoss");const s=ls(t,"predictions","hingeLoss");let o=null;null!=n&&(o=ls(n,"weights","hingeLoss")),k(a.shape,s.shape,"Error in hingeLoss: ");const i=Ps(1);a=Eo(Qs(Ps(2),a),i);const u=fi(Eo(i,Qs(a,s)));return hi(u,o,r)}});const mi=ds({minimum_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){let n=ls(e,"a","minimum"),r=ls(t,"b","minimum");[n,r]=fa(n,r),"bool"===n.dtype&&(n=ps(n,"int32"),r=ps(r,"int32")),ko(n.shape,r.shape);const a={a:n,b:r};return ka.runKernel(en,a)}});ds({huberLoss_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t,n,r=1,a=li.SUM_BY_NONZERO_WEIGHTS){const s=ls(e,"labels","huberLoss"),o=ls(t,"predictions","huberLoss");let i=null;null!=n&&(i=ls(n,"weights","huberLoss")),k(s.shape,o.shape,"Error in huberLoss: ");const u=Ps(r),l=Uo(Eo(o,s)),c=mi(l,u),d=Eo(l,c),p=So(Qs(Ps(.5),Yo(c)),Qs(u,d));return hi(p,i,a)}});const gi=ds({log_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t={x:ls(e,"x","log")};return ka.runKernel(Wt,t)}});ds({logLoss_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t,n,r=1e-7,a=li.SUM_BY_NONZERO_WEIGHTS){const s=ls(e,"labels","logLoss"),o=ls(t,"predictions","logLoss");let i=null;null!=n&&(i=ls(n,"weights","logLoss")),k(s.shape,o.shape,"Error in logLoss: ");const u=Ps(1),l=Ps(r),c=oi(Qs(s,gi(So(o,l)))),d=Qs(Eo(u,s),gi(So(Eo(u,o),l))),p=Eo(c,d);return hi(p,i,a)}});const xi=ds({squaredDifference_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){let n=ls(e,"a","squaredDifference"),r=ls(t,"b","squaredDifference");[n,r]=fa(n,r),ko(n.shape,r.shape);const a={a:n,b:r};return ka.runKernel(Yn,a,{})}});ds({meanSquaredError_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t,n,r=li.SUM_BY_NONZERO_WEIGHTS){const a=ls(e,"labels","meanSquaredError"),s=ls(t,"predictions","meanSquaredError");let o=null;null!=n&&(o=ls(n,"weights","meanSquaredError")),k(a.shape,s.shape,"Error in meanSquaredError: ");const i=xi(a,s);return hi(i,o,r)}});const bi=ds({exp_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t={x:ls(e,"x","exp")};return ka.runKernel(mt,t)}});const vi=ds({log1p_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t={x:ls(e,"x","log1p")};return ka.runKernel(Pt,t)}});ds({sigmoidCrossEntropy_:function(e,t,n,r=0,a=li.SUM_BY_NONZERO_WEIGHTS){let s=ls(e,"multiClassLabels","sigmoidCrossEntropy");const o=ls(t,"logits","sigmoidCrossEntropy");let i=null;if(null!=n&&(i=ls(n,"weights","sigmoidCrossEntropy")),k(s.shape,o.shape,"Error in sigmoidCrossEntropy: "),r>0){const e=Ps(r),t=Ps(1),n=Ps(.5);s=So(Qs(s,Eo(t,e)),Qs(n,e))}const u=
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){const n=ls(e,"labels","sigmoidCrossEntropyWithLogits"),r=ls(t,"logits","sigmoidCrossEntropyWithLogits");k(n.shape,r.shape,"Error in sigmoidCrossEntropyWithLogits: ");const a=fi(r),s=Qs(r,n),o=vi(bi(oi(Uo(r))));return So(Eo(a,s),o)}(s,o);return hi(u,i,a)}});const yi=ds({logSumExp_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function ki(e,t,n=-1){if(-1===n&&(n=t.rank-1),n!==t.rank-1)throw Error(`Softmax cross entropy along a non-last dimension is not yet supported. Labels / logits was rank ${t.rank} and dim was ${n}`);const r=(a=(e,t,r)=>{const a=yi(t,[n],!0),s=Eo(ps(t,"float32"),a);r([e,s]);const o=oi(Qs(s,e));return{value:Co(o,[n]),gradFunc:(e,t)=>{const[r,a]=t,s=Lo(e.shape,[n]);return[Qs(Hs(e,s),Eo(ps(r,"float32"),bi(a))),Qs(Hs(e,s),Eo(bi(a),ps(r,"float32")))]}}},ka.customGrad(a));var a;return r(e,t)}ds({softmaxCrossEntropy_:function(e,t,n,r=0,a=li.SUM_BY_NONZERO_WEIGHTS){let s=ls(e,"onehotLabels","softmaxCrossEntropy");const o=ls(t,"logits","softmaxCrossEntropy");let i=null;if(null!=n&&(i=ls(n,"weights","softmaxCrossEntropy")),k(s.shape,o.shape,"Error in softmaxCrossEntropy: "),r>0){const e=Ps(r),t=Ps(1),n=Ps(s.shape[1]);s=So(Qs(s,Eo(t,e)),To(e,n))}const u=ki(s,o);return hi(u,i,a)}});ds({sparseFillEmptyRows_:
/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t,n=!0){const r=ls(e,"input","stringSplit","string"),a=ls(t,"delimiter","stringSplit","string");if(1!==r.rank)throw new Error(`Input should be Tensor1D but received shape ${r.shape}`);if(0!==a.rank)throw new Error(`Delimiter should be a scalar but received shape ${a.shape}`);const s={skipEmpty:n},o={input:r,delimiter:a},i=ka.runKernel(er,o,s);return{indices:i[0],values:i[1],shape:i[2]}}});ds({stringToHashBucketFast_:
/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){const n=ls(e,"input","stringToHashBucketFast","string"),r={numBuckets:t};if(t<=0)throw new Error("Number of buckets must be at least 1");const a={input:n};return ka.runKernel(tr,a,r)}});
/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t={x:ls(e,"x","elu")};return ka.runKernel(dt,t)}});const Wi=ds({leakyRelu_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t=.2){const n={x:ls(e,"x","leakyRelu")},r={alpha:t};return ka.runKernel(_t,n,r)}});const Pi=ds({prelu_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t){const n={x:ls(e,"x","prelu"),alpha:ls(t,"alpha","prelu")};return ka.runKernel(gn,n)}});const Bi=ds({relu6_:
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t={x:ls(e,"x","relu6")};return ka.runKernel(Tn,t)}});const Li=ds({sigmoid_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e){const t={x:ls(e,"x","sigmoid")};return ka.runKernel(Wn,t)}});const zi=ds({step_:
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function(e,t=0){const n={x:ls(e,"x","step")},r={alpha:t};return ka.runKernel(hr,n,r)}});
/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function Vi(e,t,n){if(null==n||"linear"===n)return e;if("relu"===n)return Qs(e,zi(t));throw new Error(`Cannot compute gradient for fused activation ${n}.`)}function Gi(e,t){let n=t;const r=yo(e.shape,t.shape);return r.length>0&&(n=Co(n,r)),Hs(n,e.shape)}function Hi(e,t,n,r){if("linear"===t)return e;if("relu"===t)return fi(e);if("elu"===t)return Ui(e);if("relu6"===t)return Bi(e);if("prelu"===t)return Pi(e,n);if("leakyrelu"===t)return Wi(e,r);if("sigmoid"===t)return Li(e);throw new Error(`Unknown fused activation ${t}.`)}const ji=(e,t)=>!(e>0)||"linear"===t,Xi=30;function qi(e){return e<=Xi?e:K(e,Math.floor(Math.sqrt(e)))}
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
const ku="->",Iu=/->/g;function wu(e,t){const n=((e=e.replace(/\s/g,"")).length-e.replace(Iu,"").length)/ku.length;if(n<1)throw new Error("Equations without an arrow are not supported.");if(n>1)throw new Error('Equation must contain exactly one arrow ("->").');const[r,a]=e.split(ku);y(-1===r.indexOf("..."),(()=>'The ellipsis notation ("...") is not supported yet.'));const s=r.split(","),o=s.length;if(t!==o)throw new Error(`Expected ${o} input tensors, received ${t}`);if(o>2)throw new Error("Support for more than 2 input tensors is not implemented yet.");const i=[];for(let e=0;e<a.length;++e){const t=a[e];if(!s.some((e=>-1!==e.indexOf(t))))throw new Error(`Output subscripts contain the label ${t} not present in the input subscripts.`);-1===i.indexOf(t)&&i.push(t)}for(let e=0;e<r.length;++e){const t=r[e];-1===i.indexOf(t)&&","!==t&&i.push(t)}const u=new Array(s.length);for(let e=0;e<o;++e){if(new Set(s[e].split("")).size!==s[e].length)throw new Error(`Found duplicate axes in input component ${s[e]}. Support for duplicate axes in input is not implemented yet.`);u[e]=[];for(let t=0;t<s[e].length;++t)u[e].push(i.indexOf(s[e][t]))}const l=i.length,c=[];for(let e=a.length;e<l;++e)c.push(e);return{allDims:i,summedDims:c,idDims:u}}function Cu(e,t){let n=new Array(e);n.fill(-1);for(let e=0;e<t.length;++e)n[t[e]]=e;const r=[];for(let t=0;t<e;++t)-1===n[t]&&r.push(t);return n=n.filter((e=>-1!==e)),{permutationIndices:n,expandDims:r}}function Su(e,t,n){const r=new Array(e);for(let e=0;e<n.length;++e){const a=n[e].shape;for(let n=0;n<t[e].length;++n)void 0===r[t[e][n]]?r[t[e][n]]=a[n]:y(r[t[e][n]]===a[n],(()=>`Expected dimension ${r[t[e][n]]} at axis ${n} of input shaped ${JSON.stringify(a)}, but got dimension ${a[n]}`))}}function $u(e,t){const n=e,r=[];let a=0;0===e.length&&n.push(-1),a=e.length+1;for(let e=0;e<a;++e)r.push([]);const s=[];for(let e=0;e<n.length;++e){const a=Eu(t,n[e]);for(const t of a)-1===s.indexOf(t)&&(r[e].push(t),s.push(t))}return{path:n,steps:r}}function Tu(e){return e.every(((e,t)=>e===t))}function Eu(e,t){const n=[];for(let r=0;r<e.length;++r)0!==e[r].length&&-1===e[r].indexOf(t)&&-1!==t||n.push(r);return n}function Nu(e,t,n=0){let r=[];if("number"==typeof t)y(e.shape[n]%t==0,(()=>"Number of splits must evenly divide the axis.")),r=new Array(t).fill(e.shape[n]/t);else{y(t.reduce(((e,t)=>(-1===t&&(e+=1),e)),0)<=1,(()=>"There should be only one negative value in split array."));const a=t.indexOf(-1);if(-1!==a){const r=t.reduce(((e,t)=>t>0?e+t:e));t[a]=e.shape[n]-r}y(e.shape[n]===t.reduce(((e,t)=>e+t)),(()=>"The sum of sizes must match the size of the axis dimension.")),r=t}return r}
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
